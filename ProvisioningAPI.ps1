...
function Get-User
{
    ...
    Process
    {
        if($ObjectId -ne $null)
        {
            return Get-UserByObjectId -AccessToken $at -ObjectId $ObjectId -ReturnDeletedUsers $ReturnDeletedUsers
        }
        elseif($UserPrincipalName -ne $null)
        {
            return Get-UserByUpn -AccessToken $at -UserPrincipalName $UserPrincipalName -ReturnDeletedUsers $ReturnDeletedUsers
        }
        elseif($LiveID -ne $null)
        {
            return Get-UserByLiveId -AccessToken $at -LiveId $LiveID
        }
    }
}
...
function Remove-User
{
    ...
    Process
    {
        if($ObjectId -ne $null)
        {
            return Remove-UserByObjectId -AccessToken $at -ObjectId $ObjectId -RemoveFromRecycleBin $RemoveFromRecycleBin
        }
        elseif($UserPrincipalName -ne $null)
        {
            return Remove-UserByUpn -AccessToken $at -UserPrincipalName $UserPrincipalName -RemoveFromRecycleBin $RemoveFromRecycleBin
        }
