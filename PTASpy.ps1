...
#>
    ...
    Process
    {
        ...
        {
            Write-Warning "Microsoft Visual C++ 2015 Redistributable (x64) seems not to be installed! If installation fails, install from: https://download.microsoft.com/download/6/A/A/6AA4EDFF-645B-48C5-81CC-ED5963AEAD48/vc_redist.x64.exe"
        }
